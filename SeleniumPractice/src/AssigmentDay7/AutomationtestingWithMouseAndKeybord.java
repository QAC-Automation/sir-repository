...
public class AutomationtestingWithMouseAndKeybord {
	...
	List<WebElement> options3=Selectyear.getOptions();
		...
		{
			System.out.println(" "+options3.get(k).getText());
		}
	...
	for(int l=0;l<options4.size();l++)
	{
		System.out.println(" "+options4.get(l).getText());
	}
	...
	for(int m=0;m<options5.size();m++) {
		System.out.println("Option "+m+": "+options5.get(m).getText());
	}
	...
	WebElement Passwordfield=driver.findElement(By.cssSelector("input[id='firstpassword']"));
	Passwordfield.click();
	Passwordfield.sendKeys("123456");
	WebElement confirmPasswordfield=driver.findElement(By.cssSelector("input[id='secondpassword']"));
	confirmPasswordfield.click();
	confirmPasswordfield.sendKeys("123456");

	WebElement Submitbutton=driver.findElement(By.cssSelector("button[id='submitbtn']"));
